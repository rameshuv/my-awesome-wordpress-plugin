<?php
/**
 * Deprecated database functions. Use class-bhg-db.php instead.
 *
 * This file is kept for historical reference only and should not be loaded.
 *
 * @deprecated 1.0.0
 */

if ( class_exists( 'BHG_Deprecated_DB' ) ) {
    return;
}

class BHG_Deprecated_DB {}
return;

/* Original deprecated implementation below.
<?php
