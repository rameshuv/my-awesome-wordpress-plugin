...
$hunts         = (int) $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(*) FROM {$hunts_table}" ) ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Table names are hardcoded with prefix and require no placeholders.
$guesses       = (int) $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(*) FROM {$guesses_table}" ) ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Table names are hardcoded with prefix and require no placeholders.
$users         = (int) $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(*) FROM {$wpdb->users}" ) ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- WordPress users table is known and query has no dynamic parts.
$ads           = (int) $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(*) FROM {$ads_table}" ) ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Table names are hardcoded with prefix and require no placeholders.
$tournaments   = (int) $wpdb->get_var( $wpdb->prepare( "SELECT COUNT(*) FROM {$tours_table}" ) ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching -- Table names are hardcoded with prefix and require no placeholders.
?>
<div class="wrap">
